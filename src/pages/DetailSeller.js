...
function DetailSeller() {
	...
	const IconNotActive = () =>{
		return (
			<div className="notActive py-1 px-3 ms-2">
				Nonaktif
			</div>
						...
						<div className="d-flex flex-column justify-content-between ms-3 ">
							<span>
								<div className="d-flex">
									<span className="sellerName me-2 ">Red Bull</span>
									<span>
									{!profilActive ? <> {IconVerif()}</> : <>{IconNotActive()}</>}
									</span>
								</div>
								<div className="mt-2">
									<span>
			...
			<div className="box-info-seller mx-auto mt-3 ms-3">
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
						<ProfilUsaha btnActive={setProfilActive} profilActive={profilActive} />
					</div>
